...
function [ value ] = policy_value_burden20150729( x_coeff,theta, mu, lambda, n, seed)
...
for i=2:n
    ...
    emi_data(i,2)=emi_data(i-1,2)*0.25+ 0.8*a*x_coeff + psi(i,2);
    emi_data(i,3)=emi_data(i-1,3)*0.5+0.05*emi_data(i-1,3)*a*x_coeff+0.5*a*x_coeff+psi(i,3);
end
